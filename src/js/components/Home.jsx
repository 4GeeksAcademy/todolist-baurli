...
import rigoImage from "../../img/rigo-baby.jpg";
 ...
 const [taskList, setTaskList]=useState(["Do laundry","Water plants","Iron clothes","Wash dishes","Play the guitar",])
 function addTask(){
	...
	return (
		<div className="text-center d-flex flex-column">
			...
			<ul className="list-unstyled mb-0">
				{taskList.length === 0 ? (
				<li className= "empty-msg">You haven't added any task yet. Add one.</li>
				) : (
